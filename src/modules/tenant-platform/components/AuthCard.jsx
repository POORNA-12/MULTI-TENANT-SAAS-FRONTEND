    ...
    return (
        <div className="w-full max-w-md mx-auto">
            ...
            <div className="bg-portal-cardbg rounded-2xl shadow-xl shadow-black/5 border border-portal-border/60 overflow-hidden">
                ...
                {/* Alerts */}
                {error && (
                    <div className="mx-8 mb-3 px-4 py-2.5 bg-red-50 border border-red-200 rounded-xl text-sm text-portal-danger font-medium">
                        {error}
                    </div>
                )}
                {success && (
                    <div className="mx-8 mb-3 px-4 py-2.5 bg-emerald-50 border border-emerald-200 rounded-xl text-sm text-portal-success font-medium">
                        {success}
                    </div>
                )}
...
<div className="text-center mt-5">
    ...
    <p className="text-xs text-portal-textmuted mt-1.5">
        ...
        <a href="#" className="text-portal-primary hover:underline">
            Terms of Service
        </a>{' '}
        and{' '}
        <a href="#" className="text-portal-primary hover:underline">
...
<div className="text-center mt-4">
    <button
        ...
        className="text-sm font-medium text-portal-textsecondary hover:text-portal-textprimary transition-colors cursor-pointer"
    >
        ← Back to signup form
    </button>
</div>
...
<div className="flex items-center justify-between px-8 py-4 border-t border-portal-border/60 bg-portal-bg/50">
    ...
    >
        ...
        <ExternalLink className="w-3.5 h-3.5" />
            ...
            {/* Security Badges */}
<div className="flex items-center justify-center gap-6 mt-6 text-portal-textmuted">
