                    ...
                    <div className="mt-8">
                        ...
                        <nav className="space-y-1 px-2">
                            <Link
                                ...
                                className="flex items-center gap-3 px-3 py-2 rounded-md text-[#4e7397] hover:bg-slate-50 hover:text-[#0e141b] font-medium transition-colors"
                            >
                                <span className="material-symbols-outlined">settings</span>
                                {(sidebarOpen || mobileMenuOpen) && <span>Global Settings</span>}
                            </Link>
                            <Link
                            ...
                            >
                                ...
                                {(sidebarOpen || mobileMenuOpen) && <span>Support Center</span>}
                            </Link>
                        </nav>
                    </div>
                </div>
